/* Purpose: Contains All constants variables
...
public class Constants {
	...
	public static final String PROPERTIES_URI = System.getProperty("user.dir") + "\\src\\test\\resources\\configFiles\\";
	
	/** The Constant CONFIG_FILES_URI. */
	public static final String CONFIG_FILES_URI = System.getProperty("user.dir") + "\\src\\test\\resources\\configFiles\\";
	...
	public static final String ABSENCE_QUOTA_FILE = "absence_quota.csv";
	...
	public static final String ABSENCEREQUEST_EXPIRATION_PARAMETER = "absence_day_request_expiration";
